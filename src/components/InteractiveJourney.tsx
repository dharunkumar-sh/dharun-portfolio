...
const JOURNEY_DATA: TimelineItem[] = [
  {
    ...
    details: [
      "Started learning engineering",
      "Joined club community",
      "Involved in coding projects",
    ],
  ...
  },
  {
    ...
    icon: <Zap size={32} />,
    details: [
      "Gathered innovative idea",
      "Competed with fellow teams",
      "Developed unique solution",
    ],
  ...
  },
  {
    ...
    description: "React Development Intern at Tripletsoft LLC",
    icon: <Code size={32} />,
    details: [
      "Achieved Industry experience",
      "Worked with React.js and Redux",
      "Delivered unique solutions to problems",
    ],
  ...
  },
  {
    ...
    title: "Graduation",
    description:
      "Will be graduating B.Tech IT Engineering from Meenakshi Sundararajan Engineering College",
    icon: <GraduationCap size={32} />,
    details: [
      "Complete B.Tech IT",
      "Undergraduate IT degree",
      "Preparing for next career step",
    ],
  ...
  },
  {
    ...
    year: "2029",
    title: "Career Launch",
    description: "Join Google as a Software Developer Engineer and drive innovation",
    icon: <Rocket size={32} />,
    details: [
